################################################################################
# README.MD - BACKUP SYSTEM - Projet Shell Complet
################################################################################
#
# DESCRIPTION :
#   Système de sauvegarde professionnel et complet en Bash.
#   Support de 3 types de backups (FULL, INCREMENTAL, DIFFERENTIAL).
#   Synchronisation avec serveur Flask pour stockage distant.
#   Logs consolidés par jour avec gestion des sessions.
#   Restauration complète ou sélective de fichiers.
#
# STRUCTURE :
#   - backup-system/ : Scripts et système de backup
#   - serv/ : Serveur Flask pour synchronisation
#   - demo.sh : Démonstration complète
#   - Documentation : README.md, USAGE_GUIDE.md, ARCHITECTURE.sh
#
# DÉMARRAGE RAPIDE :
#   cd backup-system
...
#   - ARCHITECTURE.sh : Architecture et flux du système
#   - En-têtes des scripts : Documentation détaillée de chaque script
#
# INSTALLATION :
#   chmod +x backup-system/*.sh backup-system/lib/*.sh
#   mkdir -p backup-system/backup/{FULL,INC,DIFF} backup-system/logs
#
# COMMANDES PRINCIPALES :
#   Backup:   ./backup.sh --profile document --type full
#   Restore:  ./restore.sh --profile document
#   Upload:   ./upload.sh full
#   Verify:   ./verify_sync.sh
#
# DÉPENDANCES :
#   - bash 4+
#   - tar, gzip, md5sum
#   - Python 3 (pour serveur Flask)
#   - curl (pour upload/download)
#
# POUR PLUS D'INFOS :
#   Lire la section Documentation du README.md ci-dessous
#
################################################################################
